                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div>
                                        ...
                                        <input type="text" id="game_name" name="game_name" value="<?= $game->getName(); ?>" required autocomplete="off"/>                                      
                                    </div>
                                    <hr>
                                    <div>
                                        <label for="game_description">Description</label><br/>
                                        <textarea name="game_description" id="game_description" cols="30" rows="10"><?= $game->getDescription(); ?></textarea>
                                    </div>
                                    <hr>
                                </div>
                                <!-- Données -->
                                <div class="col-4">
                                    <div>
                                        ...
                                        <input type="file" name="game_image" id="game_image" accept="image/png, image/jpeg, image/gif, image/webp" require/>
                                    </div>
                                    <div>
                                        <label for="game_editor">Editor</label><br/>
                                        <input type="text" name="game_editor" id="game_editor" value="<?= $game->getEditor(); ?>" required autocomplete="off"/>
                                    </div>
                                    <hr>
                                    <div>
                                        <label for="game_price">Prix</label><br/>
                                        <input type="number" id="game_price" name="game_price" min="0.00" step="0.01" value="<?= $game->getPrice(); ?>" required autocomplete="off"/>
                                        <span>€</span>
                                    </div>
                                    <hr>
                                </div>
